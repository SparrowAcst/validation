...
const SEGMENTS_XLSX = "./data/structures/V3-AI-Validation-2024/10.6  Test 6. Validation of repeatability of heart sounds timing algorithm/segments.xlsx"
...
const run = async () => {
	...
	st_data = st_data.map( d => {
		...
		d.duration = last(d.segments).end
		return d
