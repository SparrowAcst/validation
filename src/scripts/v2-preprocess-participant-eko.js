...
const EKOFILES = `${RECROOT}/PT.10.8.4 v2ekocoreparticipant_/processed/*.*`

const IPHMETA = `${RECROOT}/PT.10.8.4 v2participant_/v2participant_.json`
const IPHFILES = `${RECROOT}/PT.10.8.4 v2participant_/processed/*.*`
...
//v2-participant-ekocore-raw-01-apex-01.wav
...
const run = async () => {
	...
	let res = await wav2spectrum({
		fs: `${TEMP}/participant-eko/*.wav`,
		metadata: { message: "v2-participant-eko"}, 
	...
	await saveXLSX(
		...
		"./data/processed/v2-participant-eko.xlsx"
	)
