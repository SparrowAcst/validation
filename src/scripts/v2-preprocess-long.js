...
const EKOFILES = `${RECROOT}/RRT.8.7.2 v2ekocorelong_/files/*.*`

const IPHMETA = `${RECROOT}/RRT.8.7.2 v2iph_long_/v2iph_long_.json`
const IPHFILES = `${RECROOT}/RRT.8.7.2 v2iph_long_/processed/*.*`
...
const run = async () => {
	...
	await saveXLSX(
		sortBy(res, r => r.type), //.filter(r => r.type != "N/A"),
		"./data/processed/v2-long-1.xlsx"
	)
