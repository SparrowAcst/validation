...
let dataSources = [
	{
		xlsx: "./data/structures/V3-RRT-Validation-2024/SPECTRA/v3-rrt-long-iph-spectra.xlsx",
		json: "./data/v3/rrt/v3-rrt-long-iph.json"
	},
	{
		xlsx: "./data/structures/V3-RRT-Validation-2024/SPECTRA/v3-rrt-long-predicate-spectra.xlsx",
		json: "./data/v3/rrt/v3-rrt-long-predicate.json"
	}
]



const RES_XLSX = "./data/structures/V3-RRT-Validation-2024/SPECTRA/v3-rrt-long-processed.xlsx"
