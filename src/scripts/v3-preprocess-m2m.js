...
let dataSources = [
	{
		xlsx: "./data/structures/V3-RRT-Validation-2024/SPECTRA/v3-rrt-m2m-iph-spectra.xlsx",
		json: "./data/v3/rrt/v3-rrt-m2m-iph.json"
	},
	{
		xlsx: "./data/structures/V3-RRT-Validation-2024/SPECTRA/v3-rrt-m2m-predicate-spectra.xlsx",
		json: "./data/v3/rrt/v3-rrt-m2m-predicate.json"
	}
]



const RES_XLSX = "./data/structures/V3-RRT-Validation-2024/SPECTRA/v3-rrt-m2m-processed.xlsx"
