...
const RES_XLSX = "./data/structures/V3-AI-Validation-2024/10.1.1 Test 1.1. Assessment of accuracy of heart murmur detection by Stethophone in clinical environment/stetophone-murmur-detection-new.xlsx"
