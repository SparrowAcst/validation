...
const RESULT_XLSX = "./data/structures/V3-AI-Validation-2024/10.2.1 Test 2.1. Validation of heart sounds timing by Stethophone in clinical environment/manual-fit-seg.xlsx"
...
const run = async () => {
	...
	let drive = await prepareFiles(`${GD_ROOT}`)
