...
const RES_XLSX = "./data/structures/V3-AI-Validation-2024/10.7 Test 7. Validation of informativeness of Stethophone’s heart sound analysis algorithm for recordings made by lay users/murmur-hr-assessments-lay-completeness.xlsx"
...
// 	]
	...
	console.log(`Upload to: ${GD_ROOT}/murmur-hr-assessments-lay-completeness.xlsx`)
